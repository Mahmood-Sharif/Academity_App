  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: const Color(0xFF8B0000), // Background color of the calendar pages
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            IconButton(
              icon: Icon(Icons.arrow_back_ios, color: Colors.white), // Add icon for previous month/page
              onPressed: () {
            ...
            IconButton(
              icon: Icon(Icons.arrow_forward_ios, color: Colors.white), // Add icon for next month/page
              onPressed: () {
